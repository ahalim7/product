...
public class TestUserAdminApi {
  ...
  public void testEditSuccess() throws Exception {
    ...
    MvcResult updateResult = this.mockMvc
      ...
      .andExpect(status().isOk())
      .andReturn();
    UserView newUserView = JsonHelper.fromJson(objectMapper, updateResult.getResponse().getContentAsString(), UserView.class);
  ...
  public void testDeleteAndCreateAgain() throws Exception {
    ...
    UserView newUserView = JsonHelper.fromJson(objectMapper, createResult.getResponse().getContentAsString(), UserView.class);
  ...
  public void testGetSuccess() throws Exception {
    ...
    UserView newUserView = JsonHelper.fromJson(objectMapper, getResult.getResponse().getContentAsString(), UserView.class);
