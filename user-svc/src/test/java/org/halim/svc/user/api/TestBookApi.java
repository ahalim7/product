...
import org.halim.svc.user.api.data.AuthorTestDataFactory;
import org.halim.svc.user.api.data.BookTestDataFactory;
...
public class  TestBookApi {
  ...
  public void testCreateSuccess() throws Exception {
    ...
    BookView bookView = JsonHelper.fromJson(objectMapper, createResult.getResponse().getContentAsString(), BookView.class);
  ...
  public void testEditSuccess() throws Exception {
    ...
    MvcResult updateResult = this.mockMvc
      ...
      .andExpect(status().isOk())
      .andReturn();
    BookView newBookView = JsonHelper.fromJson(objectMapper, updateResult.getResponse().getContentAsString(), BookView.class);
  ...
  public void testGetSuccess() throws Exception {
    ...
    BookView getBookView = JsonHelper.fromJson(objectMapper, getResult.getResponse().getContentAsString(), BookView.class);
  ...
  public void testGetBookAuthorsSuccess() throws Exception {
    ...
    ListResponse<AuthorView> authorViewList = JsonHelper.fromJson(objectMapper,
