...
public class TestAuthorApi {
  ...
  public void testCreateSuccess() throws Exception {
    ...
    AuthorView authorView = JsonHelper.fromJson(objectMapper, createResult.getResponse().getContentAsString(), AuthorView.class);
  ...
  public void testEditSuccess() throws Exception {
    ...
    MvcResult updateResult = this.mockMvc
      ...
      .andExpect(status().isOk())
      .andReturn();
    AuthorView newAuthorView = JsonHelper.fromJson(objectMapper, updateResult.getResponse().getContentAsString(),
      AuthorView.class);
  ...
  public void testGetSuccess() throws Exception {
    ...
    AuthorView newAuthorView = JsonHelper.fromJson(objectMapper, getResult.getResponse().getContentAsString(), AuthorView.class);
  ...
  public void testGetAuthorBooksSuccess() throws Exception {
    ...
    ListResponse<BookView> bookViewList = JsonHelper.fromJson(objectMapper,
